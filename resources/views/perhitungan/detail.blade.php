            ...
            <div class="col-md-12">
                <div class="page_title">
                    <center>
                        ...
                        <p>Metode TOPSIS digunakan untuk melakukan perangkingan, sehingga hasil akhir didapat urutan
                            siswa mulai dari yang tertinggi sampai terendah.
                        </p>
                    </center>
                </div>
            </div>
        ...
        <div class="dark_bg full margin_bottom_30">
            <div class="dark_bg full margin_bottom_30">
                <div class="graph_head">
                        ...
                        <div class="card card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    $json_solusi_ideal_positif_negatif
                                    =json_decode($kolom->solusi_ideal_positif_negatif);
                    ...
                    <br>
                    <div class="col-md-2">
                        <a class="btn btn-warning" href="{{ url('/topsis') }}"><i class="fa fa-backward"></i> Kembali</a>
                    </div>
                </div>
            </div>
        </div>
